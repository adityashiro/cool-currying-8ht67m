...
/*
  Home PlayBox Samarinda — Single-file React (App.js)
  - Dark/Light toggle
  ...
  function stopTimer(id) {
    setUnits((prev) =>
      prev.map((u) => {
        ...
        enqueueToast(`${u.name} stopped — ${minutesUsed} min`, "#0b5ea8");
        return {
          ...u,
          active: false,
          remainingSec: 0,
      ...
      <header style={styles.header}>
        <div style={styles.brand}>
          ...
          <div>
            ...
            <div style={styles.subtitle}>PS5-style billing • operator</div>
          </div>
        </div>
